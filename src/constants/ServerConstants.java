...
public class ServerConstants implements ServerConstantsMBean {
    ...
    public static final byte[] Gateway_IP = (GameConstants.GMS ? (TESPIA ? new byte[]{(byte) 0x3F, (byte) 0xFB, (byte) 0xD9, (byte) 0x72} : new byte[]{(byte) 0x8, (byte) 0x1F, (byte) 0x62, (byte) 0x34}) : new byte[]{(byte) 0xCB, (byte) 0xBC, (byte) 0xEF, (byte) 0x52}); 
    public static final short MAPLE_VERSION = (short) (GameConstants.GMS ? (TESPIA ? 10 : 103) : 123);
    public static final String MAPLE_PATCH = GameConstants.GMS ? "1" : "1";
