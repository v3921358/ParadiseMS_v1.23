...
public class PlayerInteractionHandler {
    ...
    private enum Interaction {
        CREATE(GameConstants.GMS ? 6 : 6),
        INVITE_TRADE(GameConstants.GMS ? 11 : 11),
        DENY_TRADE(GameConstants.GMS ? 12 : 12),
        VISIT(GameConstants.GMS ? 9 : 9),
        CHAT(GameConstants.GMS ? 14 : 14),
        EXIT(GameConstants.GMS ? 18 : 18),
        OPEN(GameConstants.GMS ? 16 : 16),
        SET_ITEMS(GameConstants.GMS ? 0 : 0),
        SET_MESO(GameConstants.GMS ? 1 : 1),
        CONFIRM_TRADE(GameConstants.GMS ? 2 : 2),
        PLAYER_SHOP_ADD_ITEM(GameConstants.GMS ? 40 : 38),
        BUY_ITEM_PLAYER_SHOP(GameConstants.GMS ? 22 : 22),
        ADD_ITEM(GameConstants.GMS ? 23 : 21),
        BUY_ITEM_STORE(GameConstants.GMS ? 24 : 26),
        BUY_ITEM_HIREDMERCHANT(GameConstants.GMS ? 26 : 24),
        REMOVE_ITEM(GameConstants.GMS ? 28 : 28),
        MAINTANCE_OFF(GameConstants.GMS ? 29 : 29), //This is misspelled...
        MAINTANCE_ORGANISE(GameConstants.GMS ? 30 : 30),
        CLOSE_MERCHANT(GameConstants.GMS ? 31 : 31),
        ADMIN_STORE_NAMECHANGE(GameConstants.GMS ? 35 : 35),
        VIEW_MERCHANT_VISITOR(GameConstants.GMS ? 36 : 36),
        VIEW_MERCHANT_BLACKLIST(GameConstants.GMS ? 37 : 37),
        MERCHANT_BLACKLIST_ADD(GameConstants.GMS ? 38 : 38),
        MERCHANT_BLACKLIST_REMOVE(GameConstants.GMS ? 39 : 39),
